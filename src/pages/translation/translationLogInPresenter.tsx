            ...
            <div className="row full pt3 pb3">
                <div className="col-12 pt1">
                    <Segment placeholder style={{ minHeight: 'unset' }}>
                        ...
                        <p>
                            <h4 className="m0"><b>Why do I need to be logged in?</b></h4>
                        ...
                        <p>
                            <h4 className="m0"><b>What do you store from my Google login?</b></h4>
                        ...
                        <p>
                            <h4 className="m0"><b>How long do you store my data?</b></h4>
